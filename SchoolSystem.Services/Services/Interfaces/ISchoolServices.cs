...
namespace SchoolSystem.Services.Services.Interfaces
{
    public interface ISchoolServices
    {
        ...
        public Task<AdmitSatusHelperDto> Admission(string firstName, string lastName, string subject01, string subject02, string address = null, int? classOf = null, string subject03 = null);
